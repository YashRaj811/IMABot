...
const char * ssid = "DESKTOP-FBGEEMC 6773";//Change your wifi name
const char * password = "hinet123";//Change your wifi password
...
void buzzerTask(void *pvParameters) {
    while (1) {
        ...
        vTaskDelay(300 / portTICK_PERIOD_MS); // Buzz for 3 sec
        digitalWrite(BUZZER_PIN, LOW);
        vTaskDelay(90000 / portTICK_PERIOD_MS); // Wait for 90 sec
    }
}
...
void setup() {
  ...
  if(udp.listen(1234)) {//UDP port number if there is any problem change this.
        ...
        xTaskCreatePinnedToCore(buzzerTask, "buzzerTask", 2048, NULL, 0, NULL, 0);
